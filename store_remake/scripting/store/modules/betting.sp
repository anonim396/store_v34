...
public void Betting_OnPluginStart()
{
	...
	Store_BeginModuleConfig("sourcemod/store", "betting");
	STORE_CFG("sm_store_betting", "1");
	STORE_CFG("sm_store_betting_period", "15");
	Store_EndModuleConfig("sourcemod/store", "betting");
...
#else
void Betting_OnPluginStart() {}
void Betting_OnClientDisconnect(int client)
{
